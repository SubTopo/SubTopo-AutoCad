/* SubTopo-Autocad — JavaScript */
/* SubTopo-Autocad — JavaScript extracted from cad.html */
...
function updateTitle(){
  ...
  titleEl.innerHTML = 'SubTopo-Autocad — <span class="tb-file">'+name+star+'</span> [Édition]';
}
